...
export function AuthScreen({ onLogin }: { onLogin: (account: DemoAccount) => void }) {
  ...
  function submit(event: FormEvent) {
    ...
    onLogin(accountFromIdentifier(loginIdentifier, role, mode === 'signup' ? `${firstName.trim()} ${lastName.trim()}` : undefined))
  }
